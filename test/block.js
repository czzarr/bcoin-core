...
describe('Block', function() {
  ...
  it('should decode/encode with parser/framer', function() {
    var b = bcoin.block('mainnet', parser.parseMerkleBlock(utils.toArray(raw, 'hex')), 'merkleblock');
  ...
  it('should be jsonified and unjsonified and still verify', function() {
    ...
    var b = bcoin.block('mainnet', bcoin.block.fromJSON('mainnet', json), json.subtype);
